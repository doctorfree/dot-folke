...
## Folke Lazyman Neovim Config

This repository is a fork of [Folke Lemaitre's dotfiles](https://github.com/folke/dot),
massaged to install and initialize his Neovim configuration cleanly with the
